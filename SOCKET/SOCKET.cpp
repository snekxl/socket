...
#include <vector>
#include <fstream>
#include <filesystem> // Bắt buộc phải có để dùng fs::
#include <winsock2.h>
#include <ws2tcpip.h>
...
// =====================================================================
// 4. HÀM MAIN: KÊNH ĐIỀU KHIỂN TCP VÀ TỔNG ĐÀI ĐỊNH TUYẾN
// =====================================================================
int main() {
        ...
        while (true) { 
            ...
            if (cmd == "QUIT") {
                ...
                if (fs::create_directory(arg)) {
                    ...
                    response = "550 Directory creation failed.\r\n";
                }
                send(client_sock, response.c_str(), response.length(), 0);
            }
            else if (cmd == "RMD") {
